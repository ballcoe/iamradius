...
// fetch records
$sql = "select userinfo.username,firstname,lastname,email,cid,groupname from userinfo,radcheck,radusergroup where groupname = 'Register' and ((userinfo.username = radcheck.username) and (userinfo.username = radusergroup.username))";
