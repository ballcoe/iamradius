<?php
    ...
    $sql1 = "select * from userinfo where username = '$username' and passwordportal = '$password'";
    ...
    if ($result1->num_rows > 0) {
        ...
        while($row = $result1->fetch_assoc()) {       
            ...
            $sqladdr='update userinfo set address="'.$_SERVER["REMOTE_ADDR"].'", time="'.time().'" WHERE id = "'.$row["id"].'"';	
			$conn->query($sqladdr);
			if ($ofail) {
