...
<?php include 'layout/mainpage-navbar.php' ?>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <?php
              ...
              $arrdownloads = [];
              $arruploads = [];
              $sqlinfo = 'SELECT ra.username, sum(ra.acctinputoctets) as uploads , sum(ra.acctoutputoctets) as downloads , date(ra.acctstarttime) as days FROM radacct ra where username = "'.$_SESSION["UserPortal"].'" group by days order by days DESC limit 7';
